...
Sentinel provides support for flow control by frequent ("hot spot") parameters.
...
You could refer to the sample here: [sentinel-demo-parameter-flow-control](https://github.com/alibaba/Sentinel/tree/master/sentinel-demo/sentinel-demo-parameter-flow-control)